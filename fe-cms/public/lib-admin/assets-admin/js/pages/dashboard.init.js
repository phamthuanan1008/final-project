!(function (n) {
  ...
  (o.prototype.respChart = function (o, t, r, e) {
    ...
    function l() {
      ...
      switch (t) {
        case "Doughnut":
          new Chart(i, { type: "doughnut", data: r, options: e });
          break;
        case "Bar":
          new Chart(i, { type: "bar", data: r, options: e });
      }
    }
    n(window).resize(l), l();
  }),
      ...
      this.respChart(
          ...
          datasets: [
            {
              ...
              data: [
                65, 59, 80, 81, 56, 89, 40, 32, 65, 59, 80, 81, 56, 89, 40, 32,
        ...
        },
        {
          ...
          scales: {
            ...
            xAxes: [
              { barPercentage: 0.3, gridLines: { color: "rgba(0,0,0,0.05)" } },
            ],
          },
        },
      );
